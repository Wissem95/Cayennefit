        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                        ...
                        <div className="mb-6 text-center">
                            <div className="bg-white border border-gray-200 rounded-lg p-6">
                                ...
                                <div className="space-y-3">
                                    <button className="w-full bg-gray-900 text-white py-3 px-4 rounded font-light tracking-wide hover:bg-gray-800 transition-colors">
                                        {t('details.contact')}
                                    </button>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <button className="bg-black hover:bg-gray-800 text-white px-8 py-3 font-light tracking-wider text-sm transition-all duration-300">
                        {t('details.contact')}
                    </button>
                </div>
            </main>
